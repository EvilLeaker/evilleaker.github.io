...
??? info "手台主要规格"
    ...
    - 内置128个Sensor，4颗超高速IC，DAOsesign Team全新算法，完美解决灵敏度和悬空触发的矛盾。
...
!!! tip ""
    ...
    下载**[TASOLLER_Options_V2.2.zip](https://performai.evilleaker.com/manual/download/files/TASOLLER_Options_V2.2.zip)**并解压

    双击打开**`TASOLLER_Options_V2.2.exe`**
