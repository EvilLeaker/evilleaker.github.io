...
!!! danger "目前本文仍在校对阶段，如有问题请到 [问题反馈](../../other/feedback.md) 页面反馈遇到的问题"
...
!!! danger "注意事项"
    ...
    如果您已在PC上游玩过 **maimai DX** 并且配置好了HDD，仅更换了手台，请参阅 **[配置控制器io](#io)** 部分
...
!!! tip ""
    ...
    - 将 **`K100`** 文件夹复制到HDD文件夹下的 **`package\option`** 文件夹中

    - 如option路径为 **`package\option\K100\K100`** 这样嵌套，则游戏不能正确读取option数据

    !!! warning "注意事项"

        - 本补充包包含了从旧框初代开始到DX PRiSM为止的所有官方 **已删除歌曲及相关配套的资源**，并且删除曲部分已重新排序

### 安装segatools

!!! tip ""

    下载  **<code style="color: purple;">mai2 segatools</code>**  并解压至任意文件夹

    [:octicons-arrow-down-24: Download mai2 segatools](https://oss.am-all.com.cn/download/files/mai2_segatools.zip){ .md-button .md-button--primary target="_blank"}
...
!!! tip ""
    ...
    解压 **<code style="color: purple;">ICF_1.56_K005.zip</code>**
...
!!! tip ""
    ...
    由于segatools没有图形配置工具，因此必须手动修改 **<code style="color: purple;">segatools.ini</code>** 来进行配置，配置文件位于 **<code style="color: purple;">package</code>** 文件夹

    建议您使用支持语法高亮的文本编辑器 (例如：**Notepad++、VS Code、Sublime Text**) 等软件来修改配置文件
...
!!! tip ""
    ...
    - 安装好 **<code style="color: purple;">segatools</code>** 后如无需求 **<code style="color: purple;">vfs</code>** 路径保持默认即可
...
!!! tip ""
    ...
    !!! note "如需配置CARDOLLER读卡器，请访问 [CARDOLLER 页面](../../../peripherals/cardreader/cardoller/)"

    如果你使用官方读卡器或支持官方协议的第三方读卡器，请将 **<code style="color: purple;">enable</code>** 修改为 **<code style="color: purple;">0</code>** 并正确配置读卡器端口号
    ...
    如果你没有任何读卡器设备，请将 **<code style="color: purple;">enable</code>** 修改为 **<code style="color: purple;">1</code>** 以启动segatools模拟读卡器
...
!!! tip ""
    ...
    **io4** 中的选项负责映射 **<code style="color: purple;">TEST</code>**、**<code style="color: purple;">SERVICE</code>**、**<code style="color: purple;">COIN</code>** 三个机台功能按键，默认为键盘字母上面的数字 **<code style="color: purple;">7</code>**、**<code style="color: purple;">8</code>**、**<code style="color: purple;">9</code>** 
    ...
    **1P SELECT 按键：** **<code style="color: purple;">3</code>**

    **2P SELECT 按键：** **<code style="color: purple;">小键盘 *</code>**
...
!!! tip ""
    ...
    !!! warning "设置前请确保已连接与设置好手台，手台相关教程请查看 **[Maimoller 安装使用教程](../../controller/maimai/maimoller.md)**"
...
!!! tip ""
    ...
    ??? warning "如何申请Aqua NET Keychip 与 绑定卡片"
        ...
        - 前往 **[网页端](https://aquadx.net/)**，注册并登录

        - 在 **[主页](https://aquadx.net/home)** 选项卡下点击 **连接到 AquaDX**
...
!!! tip ""
    ...
    Deer Net：**此服为半公开，本教程不提供任何接入方式说明，如需连接此服请咨询有连接资格的其他人**
...
!!! tip ""
    ...
    - 如离线服务器不支持 **maimai DX PRiSM PLUS (SDEZ 1.56)** ， 请等待作者更新再做尝试
...
!!! tip ""
    ...
    打开 **package\mai2.ini**，并按照下方高亮处设置为 **<code style="color: purple;">0</code>**：
...
!!! tip ""
    ...
    - 游戏默认为全屏运行，如需窗口启动游戏，请使用文本编辑软件编辑 **<code style="color: purple;">start.bat</code>**

    - 将下述命令中的 **<code style="color: purple;">-screen-fullscreen 1</code>** 修改为 **<code style="color: purple;">0</code>**

    ```bash
    mai2hook.dll Sinmai.exe -screen-fullscreen 0 -popupwindow -screen-width 2160 -screen-height 1920
    ```

    ---

    - **<code style="color: purple;">-popupwindow</code>** 为 **无边框窗口** 模式启动，如需使用 **有边框窗口** 请将其删除

    ```bash
    mai2hook.dll Sinmai.exe -screen-fullscreen 1 -screen-width 1080 -screen-height 1920
    ```

    ---

    保存并关闭 **<code style="color: purple;">start.bat</code>** 文件

#### 多屏幕设置

!!! tip ""

    !!! warning "仅适用于 `仅1P` 或 `仅2P` 显示模式，其他显示模式在使用手台的情况下会有显示错位"

    - 如果你的PC有多显示设备，在不修改配置的情况下游戏默认在 **主屏幕(1号屏)** 启动

    - 在不改动屏幕顺序及设置的情况下在指定屏幕启动游戏，请使用文本编辑软件编辑 **<code style="color: purple;">start.bat</code>**

    - 在下述命令末尾添加 **<code style="color: purple;">-monitor X</code>** (X为屏幕的编号，如不知道具体屏幕编号可以前往 **Windows显示设置** 中查看)

    - 该命令需要与前面的命令用空格空开

    ```bash
    mai2hook.dll Sinmai.exe -screen-fullscreen 1 -screen-width 1080 -screen-height 1920 -monitor 1
    ```
...
!!! tip ""
    ...
    - 本游戏支持以更高的分辨率来运行游戏，如需修改分辨率，请使用文本编辑软件编辑 **<code style="color: purple;">start.bat</code>**

    - 游戏的原始分辨率为 **1080x1920(单屏仅1P或2P)**、**2160x1920(双屏1P+2P)**，如需以更高分辨率运行游戏(如:1440P、4K等)，请修改下述命令中的 **-screen-width** 与 **-screen-height**
    ...
    **以4K为例，双屏分辨率：**
    ...
    ```bash
    mu3 -screen-fullscreen 1 -screen-width 4320 -screen-height 3840 -monitor 1
    ```
...
!!! warning "注意事项"
    ...
    maimai DX默认的屏幕模式为1P+2P在同一个窗口同时显示，但在仅有一个手台以及显示设备或不需要2P显示的情况下，我们需要设置一下屏幕显示模式

    目前HDD可以设置4种屏幕模式，请按照手中设备按需设置

    以下设置均以 **Maimoller** 为准，其他控制方式仅需修改 **配置和启动文件** 即可
...
!!! tip "Maimoller 1P Only"
    ...
    如果你是多显示器并且 **Maimoller**不是主屏幕，请按上面 **[多屏幕设置](#_14)** 设置为 **Maimoller** 的屏幕编号

    编辑 **<code style="color: purple;">package\mai2.ini</code>**，并按照文件中的 **注释提示** 修改下方代码高亮处：
...
!!! tip "Maimoller 1P+2P"
    ...
    - 按照 **[分辨率设置](#_15)** 将游戏分辨率设置为：

        - 单台 1080P：**2160x1920**，并将两台 **Maimoller** 在系统显示中都设置为：**1080x1920**

        - 单台 4K：**4320x3840**，并将两台 **Maimoller** 在系统显示中都设置为：**2160x3840**
...
!!! tip ""
    ...
    !!! note "注意事项"
        ...
        **Maimoller** 在启动后手台灯会全部熄灭，如果没有熄灭，请等待游戏到标题界面查看灯光是否有变化，如无变化可能手台连接出现问题，请检查手台io和连接是否有误
...
!!! tip "网络自检"
    ...
    !!! note "可能遇到的网络自检问题"
        ...
        - **<code style="color: purple;">DNS - BAD</code>** ：请检查 **segatools** 中是否填入正确的服务器地址和机台号

        - **<code style="color: purple;">IP ADDRESS - BAD</code>** ：获取IP地址失败，请尝试关闭 **Allnet Accounting**

        - **<code style="color: purple;">ALL.Net AUTHENTICATION - BAD</code>** ：**ALL.Net** 认证失败，请检查 **segatools.ini** 中 **DNS** 是否填入正确的服务器地址或 **Keychip** 中是否填入正确的机台号

        - **<code style="color: purple;">タイトルサーバー - BAD</code>** ：标题服务器连接失败，可能服务器连接出现问题，请稍后在试或尝试重启游戏

        - **<code style="color: purple;">Aime - BAD</code>** ：如果连接了读卡器外设，可能读卡器连接或设置存在问题
...
!!! tip "进行TEST菜单相关设置"
    ...
    **<code style="color: purple;">時</code>** ：设置为 **全時刻**
    ...
    在TEST菜单最下面确认 **<code style="color: purple;">配信サーバー設定</code>**　是否为 **サーバー**

    <div align="center"> <img src="https://oss.am-all.com.cn/asset/img/manual/mai_manual/mai0013.png"> </div>

    如果跟上图一样显示 **クライアント** ，请切出查看游戏窗口外的CMD窗口，确认是否有下图中的提示：

    <div align="center"> <img src="https://oss.am-all.com.cn/asset/img/manual/mai_manual/mai0014.png"> </div>

    确认有图中提示的话，请关闭游戏以及相关所有窗口，重启游戏后进入TEST菜单确认是否变更为 **サーバー**：

    <div align="center"> <img src="https://oss.am-all.com.cn/asset/img/manual/mai_manual/mai0015.png"> </div>
    ...
    遇到此情况，请返回 **[游玩前的最后设置](#_19)** 检查设置是否正确，显示 **GOOD** 即可通过此处自检
...
!!! tip ""
    ...
    !!! note "如何开启 FREE PLAY 模式"
        ...
        - 使用文本编辑软件打开 **<code style="color: purple;">package\config_common.json</code>** 文件

        - 找到 **<code style="color: purple;">”Credit”</code>** 字段

        - 修改 **<code style="color: purple;">"freeplay”</code>** 的属性值

            - **<code style="color: purple;">false</code>**：关闭

            - **<code style="color: purple;">true</code>**：开启
        ...
        <div align="center"> <img src="https://oss.am-all.com.cn/asset/img/manual/mai_manual/mai0022.png" width=400/> </div>
